  ...
  return (
    <section className="bg-white text-[#1CD2B1]" id="About">
      <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl text-[#1CD2B1]">
            About Us
          </h2>
            ...
            <div className="mt-3 space-y-12">
              <div className="flex">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center w-12 h-12 rounded-md bg-[#1CD2B1] text-white">
                    <svg
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-medium leading-6 text-[#1CD2B1]">
              ...
              <div className="mt-12 space-y-12">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                      We work closely with companies to understand their unique
                      hiring needs and tailor our services to meet their
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                      By collaborating with key stakeholders, we strengthen the
                      hiring ecosystem and facilitate connections between
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                      This feedback loop fosters transparency, accountability,
